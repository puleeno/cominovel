...
export declare interface GetFieldDecoratorOptions {
...
export declare interface DomScrollIntoViewConfig {
    /** 是否和左边界对齐 */
...
export declare interface ValidateFieldsOptions {
...
export declare interface WrappedFormUtils<V = any> {
...
export default class Form extends React.Component<FormProps, any> {
    ...
    public static createFormField: any;
    public static create: <TOwnProps extends FormComponentProps<any>>(options?: FormCreateOption<TOwnProps>) => FormWrappedProps<TOwnProps>;
    public renderForm: ({ getPrefixCls }: ConfigConsumerProps) => JSX.Element;
