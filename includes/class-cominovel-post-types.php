...
class Cominovel_Post_Types {
	...
	public static function register_post_types() {
		...
		register_post_type(
			'chapter',
			apply_filters(
				'cominovel_register_post_type_chapter',
				array(
					'labels'              => array(
						'name'                  => __( 'Chapters', 'cominovel' ),
						'singular_name'         => __( 'Chapter', 'cominovel' ),
						'all_items'             => __( 'All Chapters', 'cominovel' ),
						'menu_name'             => __( 'Chapters', 'cominovel' ),
						'add_new'               => __( 'Add new', 'ramphor_managa' ),
						...
						'view_items'            => __( 'View chapters', 'cominovel' ),
						...
						'parent'                => __( 'Parent chapter', 'cominovel' ),
						'feature_image'         => __( 'Managa image', 'cominovel' ),
						'set_feature_image'     => __( 'Set chapter image', 'cominovel' ),
						'remove_feature_image'  => __( 'Remove chapter image', 'cominovel' ),
						'use_featured_image'    => __( 'Use as chapter image', 'cominovel' ),
						'insert_into_item'      => __( 'Insert into chapter', 'cominovel' ),
						'uploaded_to_this_item' => __( 'Uploaded to this chapter', 'cominovel' ),
						'filter_items_list'     => __( 'Filter chapters', 'cominovel' ),
						'items_list_navigation' => __( 'Chapters navigation', 'cominovel' ),
						'items_list'            => __( 'Chapters list', 'cominovel' ),
					),
					'description'         => __( 'This is where you can add new chapter for your website.', 'cominovel' ),
					'public'              => true,
					'show_ui'             => true,
		...
		register_taxonomy(
			...
			apply_filters(
				...
				array(
					...
					'labels'                => array(
						'name'              => __( 'Comic genres', 'cominovel' ),
